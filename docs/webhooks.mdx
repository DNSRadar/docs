...
<ParamField path="event.domain" type="string" required>
  The root domain being monitored
</ParamField>

<ParamField path="event.subdomain" type="string">
  The subdomain being monitored (if applicable)
</ParamField>

<ParamField path="event.record_type" type="string" required>
  The DNS record type (A, AAAA, CNAME, MX, TXT, etc.)
</ParamField>

<ParamField path="event.expected_value" type="array" required>
...
<ParamField path="event.previous_value" type="array" required>
  The DNS record values before this event
</ParamField>

<ParamField path="event.current_value" type="array" required>

...
description: "Learn how to authenticate your API requests with DNSTail"
---

## API Key Authentication

The DNSTail API uses API keys to authenticate requests. All API requests must include your secret API key in the request header to identify your account and authorize access.
...
You can create and manage your API keys from the [DNSTail Dashboard](https://dashboard.dnstail.com):
...
<CodeGroup>
```bash cURL
curl https://api.dnstail.com/monitors \
...
response = requests.get('https://api.dnstail.com/monitors', headers=headers)
```

```php PHP
$ch = curl_init('https://api.dnstail.com/monitors');
